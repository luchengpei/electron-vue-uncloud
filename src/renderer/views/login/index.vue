    ...
    <div class="login-container">
        <div class="login-from-box">
            ...
            >
                ...
                <div class="tips">
                    <span style="margin-right:20px;">用户名: lcp</span>
                    <span>密码：随便什么都行</span>
                </div>
            </el-form>
        </div>
...
import loginApi from "@/api/login_new.js";
export default {
    name: "login",
    data() {
...
.login-container {
    ...
    .login-from-box {
        ...
        .login-form {
            ...
            align-items: center;
            color: white;
            background: rgba(227, 217, 202, 0.8);
            border-radius: 10px;
            box-shadow: 0 0.4px 0.6px rgba(0, 0, 0, 0.141), 0 1px 1.3px rgba(0, 0, 0, 0.202),
                ...
                0 6.3px 8.4px rgba(0, 0, 0, 0.359), 0 15px 20px rgba(0, 0, 0, 0.5);
            .login-btn {
                .btn {
                    position: relative;
                    width: 100%;
                    ...
                    color: white;
                    background: transparent;
                    border: 2px solid hsla(217, 70%, 53%, 1);
                    outline: none;
                    cursor: pointer;
                    overflow: hidden;
                    transition: 0.5s;
